...
_080033AC:
	...
	cmp r0, #5
	bhi _080033E4
	ldr r2, _0800344C  @ =0x03000B4C
	ldrb r0, [r4, #4]
	sub r0, r0, #28
	lsl r0, r0, #2
	ldr r3, _08003450  @ =0x08078214
	add r0, r0, r3
	mov r3, #0
	ldrsh r1, [r0, r3]
	ldr r0, [r2]
...
sub_080062D0: @ 0x080062D0
	...
	mov r8, r1
	ldr r2, _0800637C  @ =0x0807820C
	mov r12, r2
_080062FC:
	mov r7, #6
	ldrsh r1, [r4, r7]
	ldr r2, _08006380  @ =0x08078234
	ldr r0, [r2, #4]
	add r1, r1, r0
	mov r7, #4
	ldrsh r3, [r4, r7]
