	...
	THUMB_FUNC_START sub_080324DC
sub_080324DC: @ 0x080324DC
	push {r4,lr}
	sub sp, sp, #16
	bl sub_080331FC
	ldr r0, _08032500  @ =gUnknown_0300029C
	ldr r0, [r0]
	mov r1, #128
	lsl r1, r1, #5
	add r0, r0, r1
...
_080324F6:
	lsl r0, r0, #2
	ldr r1, _08032504  @ =0x08032508
	add r0, r0, r1
	ldr r0, [r0]
	mov pc, r0
_08032500:
	.4byte gUnknown_0300029C
_08032504:
	.4byte _08032508
_08032508:
	.4byte _0803252C
...
_0803252C:
	...
	cmp r0, #0
	bne _08032558
	ldr r0, _0803254C  @ =gUnknown_0300029C
	ldr r1, [r0]
	mov r0, #128
	lsl r0, r0, #5
	add r2, r1, r0
	mov r0, #8
	str r0, [r2]
	ldr r0, _08032550  @ =0x00001008
	add r1, r1, r0
	ldr r0, _08032554  @ =gUnknown_0807DD1C
	str r0, [r1]
	b _080326F8
_0803254C:
	.4byte gUnknown_0300029C
_08032550:
	.4byte 0x00001008
_08032554:
	.4byte gUnknown_0807DD1C
_08032558:
	bl sub_0802A464
	add r1, r0, #0
	cmp r1, #1
	bne _08032578
	ldr r0, _08032574  @ =gUnknown_0300029C
	ldr r0, [r0]
	mov r1, #128
	lsl r1, r1, #5
	add r0, r0, r1
...
_08032582:
	...
	bne _080325B0
_0803258A:
	ldr r0, _080325A4  @ =gUnknown_0300029C
	ldr r1, [r0]
	mov r0, #128
	lsl r0, r0, #5
	add r2, r1, r0
	mov r0, #8
	str r0, [r2]
	ldr r0, _080325A8  @ =0x00001008
	add r1, r1, r0
	ldr r0, _080325AC  @ =gUnknown_0807DD1C
	add r0, r0, #8
	str r0, [r1]
	b _080326F8
_080325A4:
...
_080325AC:
	.4byte gUnknown_0807DD1C
_080325B0:
	ldr r0, _080325C8  @ =gUnknown_0300029C
	ldr r0, [r0]
	mov r1, #128
	lsl r1, r1, #5
	add r0, r0, r1
	mov r1, #2
	str r1, [r0]
	ldr r1, _080325CC  @ =gUnknown_03000B50
	mov r0, #1
	strb r0, [r1]
	b _080326F8
	.byte 0x00
...
_080325D0:
	...
	cmp r0, #0
	bne _0803269E
	ldr r0, _080325F4  @ =gUnknown_0300029C
	ldr r1, [r0]
	mov r0, #128
	lsl r0, r0, #5
	add r2, r1, r0
	mov r0, #8
	str r0, [r2]
	ldr r0, _080325F8  @ =0x00001008
	add r1, r1, r0
	ldr r0, _080325FC  @ =gUnknown_0807DD1C
	add r0, r0, #16
	str r0, [r1]
	b _080326F8
	.byte 0x00
...
_08032600:
	...
	mov r1, #0
	bl sub_080070E8
	ldr r0, _08032618  @ =gUnknown_080788FC
	ldr r0, [r0]
	ldr r0, [r0]
	lsl r0, r0, #26
	lsr r0, r0, #31
...
_0803261C:
	...
	bl sub_08011428
	bl sub_0802A164
	ldr r0, _08032638  @ =gUnknown_0300029C
	ldr r0, [r0]
	mov r1, #128
	lsl r1, r1, #5
	add r0, r0, r1
...
_08032642:
	...
	mov r0, #0
	strh r0, [r1]
	ldr r0, _08032674  @ =gUnknown_0807CA94
	ldr r1, [r0]
	ldr r2, _08032678  @ =0x01000034
	add r0, sp, #12
	bl CpuSet
	bl sub_0802A164
	bl sub_0802F1D4
_08032662:
	ldr r0, _0803267C  @ =gUnknown_0300029C
	ldr r0, [r0]
	mov r1, #128
	lsl r1, r1, #5
	add r0, r0, r1
...
_08032680:
	mov r0, #1
	bl sub_08011428
	ldr r1, _080326B0  @ =gUnknown_03000B50
	mov r0, #2
	strb r0, [r1]
	mov r0, sp
	add r0, r0, #14
	mov r1, #0
	strh r1, [r0]
	ldr r1, _080326B4  @ =gUnknown_0807CA94
	ldr r1, [r1]
	ldr r2, _080326B8  @ =0x01000034
	bl CpuSet
_0803269E:
	ldr r0, _080326BC  @ =gUnknown_0300029C
	ldr r0, [r0]
	mov r1, #128
	lsl r1, r1, #5
	add r0, r0, r1
...
_080326BC:
	.4byte gUnknown_0300029C
_080326C0:
	ldr r0, _08032700  @ =gUnknown_030012E8
	ldrh r1, [r0]
	mov r0, #11
	and r0, r0, r1
	cmp r0, #0
	...
	mov r3, #64
	bl sub_08071990
	ldr r0, _08032704  @ =gUnknown_0300029C
	ldr r0, [r0]
	mov r1, #128
	lsl r1, r1, #5
	add r2, r0, r1
...
_08032704:
	.4byte gUnknown_0300029C
	THUMB_FUNC_END sub_080324DC

	THUMB_FUNC_START sub_08032708
sub_08032708: @ 0x08032708
	push {r4-r6,lr}
	sub sp, sp, #12
	add r5, sp, #8
	mov r0, #0
	...
	mov r0, #160
	str r0, [sp, #4]
	ldr r4, _08032768  @ =0x040000D4
	add r0, sp, #4
	str r0, [r4]
	ldr r6, _0803276C  @ =0x03000EA0
	str r6, [r4, #4]
	ldr r0, _08032770  @ =0x85000100
	str r0, [r4, #8]
	ldr r0, [r4, #8]
	bl sub_080351E0
	ldr r0, _08032774  @ =gUnknown_0300029C
	ldr r0, [r0]
	ldr r1, _08032778  @ =0x00001008
	add r0, r0, r1
	ldr r0, [r0]
	cmp r0, #0
	beq _0803274A
	ldr r0, [r0]
	ldr r2, _0803277C  @ =0xFFFF8001
	mov r3, #1
	neg r3, r3
	mov r1, #16
	str r1, [sp]
...
_08032780:
	.4byte 0x84000100
	THUMB_FUNC_END sub_08032708

	THUMB_FUNC_START sub_08032784
sub_08032784: @ 0x08032784
	bx lr
	THUMB_FUNC_END sub_08032784
...
sub_08032788: @ 0x08032788
	...
	add r6, r0, #0
	add r5, r1, #0
	ldr r0, _080327FC  @ =gUnknown_080788FC
	ldr r0, [r0]
	ldrb r0, [r0]
	mov r1, #24
	and r1, r1, r0
	...
	lsl r2, r6, #11
	lsl r0, r4, #10
	ldr r1, _08032800  @ =gUnknown_08081D98
	add r0, r0, r1
	add r2, r2, r0
	ldr r1, _08032804  @ =0x040000D4
	str r2, [r1]
	mov r0, #160
	lsl r0, r0, #19
	str r0, [r1, #4]
	ldr r0, _08032808  @ =0x80000100
	str r0, [r1, #8]
	ldr r0, [r1, #8]
	mov r0, #0
	mov r1, #0
...
_080327C8:
	...
	ldr r1, _08032804  @ =0x040000D4
	str r2, [r1]
	ldr r0, _0803280C  @ =0x05000200
	str r0, [r1, #4]
	ldr r0, _08032810  @ =0x84000080
	str r0, [r1, #8]
	ldr r0, [r1, #8]
	mov r0, #0
	mov r1, #1
