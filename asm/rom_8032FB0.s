...
sub_08033588: @ 0x08033588
	...
	add r3, r0, #0
	add r4, r1, #0
	ldr r0, _080335A8  @ =gUnknown_030002B0
	ldr r1, [r0]
	add r6, r0, #0
	cmp r1, r3
	bne _080335B4
	ldr r0, _080335AC  @ =gUnknown_030002C8
	mov r1, #0
	str r1, [r0]
	ldr r1, _080335B0  @ =gUnknown_030002B8
	str r3, [r1]
	add r7, r0, #0
	add r5, r1, #0
	b _08033600
...
_080335B4:
	ldr r0, _080335EC  @ =gUnknown_030002B8
	str r3, [r0]
	add r5, r0, #0
	cmp r3, #0
	bge _080335C2
...
_080335C2:
	...
	asr r0, r0, #8
	add r0, r0, #240
	ldr r1, _080335F0  @ =gUnknown_03001720
	mov r3, #0
	ldrsh r1, [r1, r3]
	cmp r0, r1
	blt _080335DA
...
_080335DA:
	...
	cmp r0, #0
	ble _080335F8
	ldr r0, _080335F4  @ =gUnknown_030002C8
	str r2, [r0]
	add r7, r0, #0
	b _08033600
_080335EC:
...
_080335F4:
	.4byte gUnknown_030002C8
_080335F8:
	ldr r1, _08033610  @ =gUnknown_030002C8
	neg r0, r2
	str r0, [r1]
	add r7, r1, #0
_08033600:
...
_08033620:
	...
	asr r0, r0, #8
	add r0, r0, #160
	ldr r1, _08033648  @ =gUnknown_0300170C
	mov r4, #0
	ldrsh r1, [r1, r4]
	cmp r0, r1
	blt _08033638
